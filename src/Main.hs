...
renderPuzzleChar val = case val of (Just char) -> char; Nothing -> '_'
...
alreadyGuessed (Puzzle _ _ list) char = elem char list
...
handleGuess puzzle guess = do
  ...
  case (charInWord puzzle guess, alreadyGuessed puzzle guess) of
    (_, True) -> do
      putStrLn "You already guessted that\n character, pick something else!"
      return puzzle
    (True, _) -> do
...
runGame puzzle = forever $ do
  gameOver puzzle
  gameWin puzzle
  putStrLn $ "Current puzle is " ++ show puzzle
